...
public:
    void registerTypes(const char *uri)
    {
        ...
        qmlRegisterUncreatableType<BinaryExpression>(uri, 1, 0, "BinaryExpression", abstractBaseClass);
        qmlRegisterUncreatableType<Parameter>(uri, 1, 0, "Parameter", abstractBaseClass);
        qmlRegisterUncreatableType<UnaryExpression>(uri, 1, 0, "UnaryExpression", abstractBaseClass);
